...
public class CircledImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CircledImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircledImageView_borderWidth, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircledImageView_borderColor, DEFAULT_BORDER_COLOR);
        a.recycle();
        init();
    }
