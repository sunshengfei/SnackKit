...
import com.freddon.android.snackkit.extension.widget.MaskLayoutView;
import com.freddon.android.snackkit.extension.widget.MaskLoadingView;

/**
 * Created by fred on 2016/11/5.
 */

public class LayersLayout extends FrameLayout implements View.OnClickListener {
    ...
    MaskLayoutView emptyLayoutMask;
    MaskLayoutView emptyLayoutNetError;
    MaskLayoutView emptyLayoutException;
    ...
    public LayersLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initLayout(Context context) {
        ...
        layoutInflater.inflate(R.layout.layers_layout, this);
